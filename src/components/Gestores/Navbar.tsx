  ...
  return (
    <aside style={styles.sidebar}>
      ...
      <div style={styles.topSection}>
        ...
        <h2 style={styles.userName}>{usuario.Nome}</h2>
      </div>

      {/* Menu Principal */}
      <nav style={{ flex: 5, overflow: "auto", marginTop: 16 }}>
        <ul style={styles.menuList}>
          <li style={styles.menuItem} onClick={goToAlunos} tabIndex={0} role="button" aria-label="Alunos">
            <VscAccount style={styles.icon} />
            <span>Alunos</span>
          </li>
          <li style={styles.menuItem} onClick={goToProfessores} tabIndex={0} role="button" aria-label="Professores">
            <LiaChalkboardTeacherSolid style={styles.icon} />
            <span>Professores</span>
          </li>
          <li style={styles.menuItem} onClick={goToEventos} tabIndex={0} role="button" aria-label="Eventos Escolares">
            <FaCalendarAlt style={styles.icon} />
            <span>Eventos Escolares</span>
          </li>
          <li style={styles.menuItem} onClick={goToResponsaveis} tabIndex={0} role="button" aria-label="Responsáveis">
      ...
      <footer style={styles.footer}>
        <button 
          onClick={() => alert("Usuário solicitou ajuda")}
        ...
        <button
          onClick={() => alert("Usuário acessou configurações")}
          style={styles.footerButton}
          onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "rgba(255, 255, 255, 0.15)")}
          onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "transparent")}
        ...
        <button
          onClick={() => (typeof window !== "undefined" ? (window.location.href = "/") : null)}
          style={styles.footerButton}
          onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "rgba(255, 255, 255, 0.15)")}
          onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "transparent")}
          aria-label="Sair"
...
const SettingsIcon = () => (
  <svg width="25" height="30" viewBox="0 0 35 39" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: 10 }}>
    ...
    />
    <path
      d="M17.3502 24.5454C19.8093 24.5454 21.8029 22.2865 21.8029 19.5C21.8029 16.7135 19.8093 14.4545 17.3502 14.4545C14.8911 14.4545 12.8976 16.7135 12.8976 19.5C12.8976 22.2865 14.8911 24.5454 17.3502 24.5454Z"
      stroke="white"
      strokeWidth="2"
    />
  </svg>
