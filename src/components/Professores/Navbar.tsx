...
export default function Navbar({ usuario }: Props) {
  ...
  const goToAtividade = () => router.push(`/professor/atividade/${usuario.Id}`);
  const goToGradeCurricular = () => router.push(`/professor/grade-curricular/${usuario.Id}`);
  const goToProva = () => router.push(`/professor/prova/${usuario.Id}`);
  const goToBoletim = () => router.push(`/professor/boletim/${usuario.Id}`);
